...
class ProductionConfig(Config):
    ...
    SQLALCHEMY_DATABASE_URI = ("postgresql://postgres:valenPostgres@localhost:5000/DSSD14") #"postgresql://postgres:cabj1211@localhost:5432/DSSD14"
...
class DevelopmentConfig(Config):
    ...
    DB_NAME = environ.get("DB_NAME", "MY_DB_NAME")
    SQLALCHEMY_TRACK_MODIFICATIONS = False
    SQLALCHEMY_DATABASE_URI = ("postgresql://postgres:cabj1211@localhost:5432/DSSD14") #"postgresql://postgres:cabj1211@localhost:5432/DSSD14"
